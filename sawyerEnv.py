...
class sawyerEnv(gym.Env):
	...
	def reset(self):
		...
		# self.objectId = p.loadURDF("random_urdfs/057/057.urdf", xpos, ypos, -0.1, orn[0], orn[1], orn[2], orn[3]) # line 98
		self.objectId = p.loadURDF('random_urdfs/021/021.urdf', [0.95,0,-0.1],p.getQuaternionFromEuler([0,0,3.1415]))
